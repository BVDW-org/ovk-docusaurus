...
Soll eine andere DSP zum Einsatz kommen, kann ein möglicher technischer Workaround im Vorfeld geklärt werden. Details finden Sie in der [ID Landscape Map](https://tech.ovk.de/docs/tools/id-landscape-map).
...
Beispiele finden Sie in den [Case Studies](./Case%20Studies.md).
