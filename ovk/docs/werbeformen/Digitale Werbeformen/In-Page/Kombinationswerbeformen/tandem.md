...
## Beschreibung
Neben den linearen und non-linearen Video Ads besteht die Möglichkeit, ein Tandem Ad zu schalten. Dieses lässt sich allerdings nicht als eine eigene Werbeform bezeichnen sondern vielmehr als die Darstellung verschiedener Werbeformen (In-Stream oder In-Page) auf derselben Seite und des selben Werbungtreibenden.
